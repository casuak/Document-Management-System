package team.abc.ssm.modules.document.authorStatistics.api;
 ...
 */
@Controller
@RequestMapping(value = "/authorStatistics")
public class AuthorStatisticsApi extends BaseApi {

    private static final Logger LOG = LoggerFactory.getLogger(AuthorStatisticsApi.class);
    ...
    public ModelAndView goAuthorStatistics(
        ...
        modelAndView.setViewName("functions/document/authorStatistics/authorStatistics");

        List<Map<String, String>> paperType = paperSearchService.getPaperType();

        List<String> orgList = functionService.getOrgList();

        List<String> subjectList = authorStatisticsService.getSubList();
    ...
    public Object getAuthorStatisticsByPage(
        ...
        List<AuthorStatistics> authorList = authorStatisticsService.getAuthorStatisticsList(authorStatistics);
        //设置返回的authorList信息
    ...
    public Object getAuthorStatisticsByMajor(
        ...
        Page<AuthorStatistics> data = new Page<>();
        List<AuthorStatistics> authorList = authorStatisticsService.getAuthorStatisticsByMajor(authorStatistics);
        //设置返回的authorList信息
        data.setResultList(authorList);
        //设置查询出的作者总数
    ...
    public Object getAuthorStatisticsBySchool(
        ...
        Page<AuthorStatistics> data = new Page<>();
        List<AuthorStatistics> authorList = authorStatisticsService.getAuthorStatisticsBySchool(authorStatistics);
        //设置返回的authorList信息
        data.setResultList(authorList);
        //设置查询出的作者总数
        data.setTotal(authorList.size());
