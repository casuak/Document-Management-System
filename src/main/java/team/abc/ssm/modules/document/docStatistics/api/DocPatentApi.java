package team.abc.ssm.modules.document.docStatistics.api;
...
public class DocPatentApi extends BaseApi {
    ...
    public Object setPatentAuthor(
        ...
        int res = patentService.setPatentAuthor(patentId, authorIndex, authorId,userType);
        if (res == 1){
            return retMsg.Set(MsgType.SUCCESS);
        }else {
    ...
    public Object selectPatentListByPageGet(
        ...
        modelAndView.setViewName("functions/document/patent/patentList");
