...
<head>
    ...
    <link rel="stylesheet" href="/static/css/functions/document/docStatistics/docSearch.css"/>
    <style>
        html {
            height: 100%;
            overflow: auto;
...
<script>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            exportStatisticResult() {
                ...
                window.location.href = "/authorStatistics/exportStatisticsList?" +
            ...
            exportStatisticMajorResult() {
                let app = this;
                window.location.href = "/authorStatistics/exportStatisticsMajorList?" +
                    "&major=" + app.optionView.major.major
            },
            exportStatisticSchoolResult() {
                let app = this;
                window.location.href = "/authorStatistics/exportStatisticsSchoolList?" +
    ...
    function authorSearch() {
        ...
        console.log(app.optionView.commonSelect.startYear);
        setTimeout(function () {
            ajaxPostJSON("/authorStatistics/getAuthorStatisticsByPage", author,
    ...
    function schoolSearch() {
        ...
        setTimeout(function () {
            ajaxPostJSON("/authorStatistics/getAuthorStatisticsBySchool", author,
                function success(res) {
                    if (res.code === 'success') {
                        console.log(res.data.resultList);
    ...
    function majorSearch() {
        ...
        setTimeout(function () {
            ajaxPostJSON("/authorStatistics/getAuthorStatisticsByMajor", author,
                function success(res) {
                    if (res.code === 'success') {
                        console.log(res.data.resultList);
